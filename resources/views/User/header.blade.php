...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light" aria-label="Tenth navbar example">
            <div class="container-fluid">
                ...
                <div class="dropdown">
                    <button class="btn btn-book-a-table dropdown-toggle" type="button" data-bs-toggle="dropdown"
                        aria-expanded="false">{{ Auth::user()->nama }}</button></a>
    ...
    @endauth
    @yield('content')
    <a href='http://wa.me/6282323882731' target='blank' class='whatsapp shadow-lg d-flex align-items-center'>
